...
void FDCAN1_RxFilter_Config(void)
{
	...
	if(HAL_FDCAN_ConfigGlobalFilter(&hfdcan1,FDCAN_ACCEPT_IN_RX_FIFO0,FDCAN_ACCEPT_IN_RX_FIFO0,FDCAN_FILTER_REMOTE,FDCAN_FILTER_REMOTE) != HAL_OK)//����ȫ������
	{
		Error_Handler();//����Ӳ������
	}
	
	if(HAL_FDCAN_ActivateNotification(&hfdcan1, FDCAN_IT_RX_FIFO0_NEW_MESSAGE, 0) != HAL_OK)//����FIFO0�ж�
	{
		Error_Handler();//����Ӳ������
	}
...
void FDCAN2_RxFilter_Config(void)
{
	...
	if(HAL_FDCAN_ConfigGlobalFilter(&hfdcan2,FDCAN_ACCEPT_IN_RX_FIFO0,FDCAN_ACCEPT_IN_RX_FIFO0,FDCAN_FILTER_REMOTE,FDCAN_FILTER_REMOTE) != HAL_OK)//����ȫ������
	{
		Error_Handler();//����Ӳ������
	}
	
	if(HAL_FDCAN_ActivateNotification(&hfdcan2, FDCAN_IT_RX_FIFO0_NEW_MESSAGE, 0) != HAL_OK)//����FIFO0�ж�
	{
		Error_Handler();//����Ӳ������
	}
...
void FDCAN3_RxFilter_Config(void)
{
	...
	if(HAL_FDCAN_ConfigGlobalFilter(&hfdcan3,FDCAN_ACCEPT_IN_RX_FIFO1,FDCAN_ACCEPT_IN_RX_FIFO1,FDCAN_FILTER_REMOTE,FDCAN_FILTER_REMOTE) != HAL_OK)//����ȫ������
	{
		Error_Handler();//����Ӳ������
	}
	
	if(HAL_FDCAN_ActivateNotification(&hfdcan3, FDCAN_IT_RX_FIFO1_NEW_MESSAGE, 0) != HAL_OK)//����FIFO0�ж�
	{
		Error_Handler();//����Ӳ������
	}
